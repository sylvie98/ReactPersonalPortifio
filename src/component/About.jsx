...
const About = () => {
  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
      ...
      <div>
      <h2 className=' text-[#9c3088] font-bold text-3xl mt-5'>WELCOME TO MY WORLD</h2>
               <h3 className=' text-2xl mt-5 font-bold'>Hi, I'm <span className=' text-[#9c3088] font-bold'> Sylvie Masengesho </span> a Front-End Developer</h3>
               <p className=' mt-8'>
