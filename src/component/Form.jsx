  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
      <div className='rounded-lg bg-gray-50  shadow-inner shadow-[#e461ce] sm:p-8 h-full w-full lg:col-span-2'>
        ...
        <h1 className=' text-3xl mt-5 font-bold mb-5'>Sylvie Masengesho</h1>
        <h2 className=' text-2xl mb-4'>I am front developer</h2>
        <p class="max-w-xl ">
      ...
      <div class="rounded-lg p-8  bg-gray-50  shadow-inner shadow-[#e461ce] lg:col-span-3">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div class="mt-4">
            <button
              type="submit"
              class="w-full rounded-lg border-gray-200 p-3 text-sm bg-[#8a1a75] text-white"
            >
              Send Message
            </button>
          </div>
